	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="办公地点" prop="bangongdidian">
					<el-input v-model="ruleForm.bangongdidian" placeholder="办公地点" clearable  :readonly="ro.bangongdidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="办公地点" prop="bangongdidian">
					<el-input v-model="ruleForm.bangongdidian" placeholder="办公地点" readonly></el-input>
				</el-form-item>
