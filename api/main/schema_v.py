...
@main_bp.route("/pythons93f13ht/cal/<tableName>/<columnName>", methods=['GET'])
def pythons93f13ht_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/pythons93f13ht/file/download", methods=['GET'])
def pythons93f13ht_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythons93f13ht/file/upload", methods=['POST'])
def pythons93f13ht_file_upload():
    '''
    '''
...
@main_bp.route("/pythons93f13ht/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def pythons93f13ht_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythons93f13ht/follow/<tableName>/<columnName>", methods=['GET'])
def pythons93f13ht_follow(tableName, columnName):
    '''
...
@main_bp.route("/pythons93f13ht/location", methods=['GET'])
def pythons93f13ht_location():
    '''
...
@main_bp.route("/pythons93f13ht/matchFace", methods=['GET'])
def pythons93f13ht_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythons93f13ht/option/<tableName>/<columnName>", methods=['GET'])
def pythons93f13ht_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythons93f13ht/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def pythons93f13ht_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythons93f13ht/sh/<tableName>", methods=['POST'])
def pythons93f13ht_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("pythons93f13ht_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/pythons93f13ht/upload/<fileName>", methods=['GET'])
def pythons93f13ht_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythons93f13ht/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/pythons93f13ht/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
