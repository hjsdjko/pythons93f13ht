...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/pythons93f13ht/examusers/login" ,
            "/pythons93f13ht/examusers/register",
            '/pythons93f13ht/defaultuser/login',
            '/pythons93f13ht/users/login',
        ...
        post_list = [
            '/pythons93f13ht/defaultuser/register',
            '/pythons93f13ht/defaultuser/login',
            '/pythons93f13ht/users/register',
            '/pythons93f13ht/users/login',
            "/pythons93f13ht/examusers/login" ,
            "/pythons93f13ht/examusers/register"
        ]  # 免认证list
